...
it('can construct 5 hops single (non-mpp) route', () => {
  const currentblockHeight = 677883;
  ...
  var totalFees = 0;
  for (var i = 0; i < lndRoute.routes[0].hops.length; i++) {
    totalFees += parseInt(lndRoute.routes[0].hops[i].fee_msat, 10);
  }
  ...
  const expectedHops = [
    {
      pubkey: hopFees.node1_pub,
      short_channel_id: firstChanId,
      fee_msat: Math.floor((totalFees * parseInt(hopFees.node1_policy.fee_rate_milli_msat, 10)) / 1000000) + parseInt(hopFees.node1_policy.fee_base_msat, 10),
      cltv_expiry_delta: hopFees.node1_policy.time_lock_delta, // node1_policy.time_lock_delta
    },
    {
      pubkey: '03864ef025fde8fb587d989186ce6a4a186895ee44a926bfc370e2c366597a3f8f',
      short_channel_id: '734240670981095424',
      fee_msat: 1,
      cltv_expiry_delta: lndRoute.routes[0].hops[1].expiry - lndRoute.routes[0].hops[0].expiry,
    },
    {
      pubkey: 'bb',
      short_channel_id: '42',
      fee_msat: 2,
      cltv_expiry_delta: lndRoute.routes[0].hops[2].expiry - lndRoute.routes[0].hops[1].expiry,
    },
    {
      pubkey: 'cc',
      short_channel_id: '43',
      fee_msat: 3,
      cltv_expiry_delta: lndRoute.routes[0].total_time_lock - lndRoute.routes[0].hops[2].expiry,
    },
    {
      pubkey: '037cc5f9f1da20ac0d60e83989729a204a33cc2d8e80438969fadf35c1c5f1233b',
      short_channel_id: '697176133925208065',
