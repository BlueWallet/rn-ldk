...
- (NSArray<NSString *> *)supportedEvents {
    return @[@"broadcast",@"register_tx",@"log",@"marker_register_output",@"broadcast",@"persist",@"payment_sent",@"payment_failed",@"payment_received", @"payment_path_failed", @"persist_manager",@"funding_generation_ready",@"channel_closed"];
}
